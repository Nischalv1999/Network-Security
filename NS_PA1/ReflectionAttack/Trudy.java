...
// adding encrypted N3-1 received from Bob from previous session and using it in original session.
msgToBob.add(new String("Trudy"));
msgToBob.add(listOfMessagesBob.get(1));
// Byte[] temp1=
Byte[] temp=(Byte[]) listOfMessagesBob.get(1);
System.out.println("Trudy: N3: "+Arrays.toString(temp));
      try {
